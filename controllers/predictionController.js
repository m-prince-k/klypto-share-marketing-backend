...
const { generate_payload } = require("../services/prediction_engine/calculate_parameters.js");
const db = require("../services/prediction_engine/db.js");
const tickCollector = require("../services/prediction_engine/tick-collector.js");
const angelone = require("../services/prediction_engine/angelone-client.js");
const symbols = require("../services/prediction_engine/symbols.js");
...
router.get("/strategy/predict", async (req, res) => {
...
router.get("/predictResult", async (req, res) => {
  try {
...
async function start() {
  try {
    ...
    // app.listen was here, removed since index.js manages the server
  } catch (err) {
...
module.exports = { predictionRouter: router, startPredictionServices: start };
