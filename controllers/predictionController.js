...
const db = require("../services/prediction_engine/db");
const tickCollector = require("../services/prediction_engine/tick-collector");
const angelone = require("../services/prediction_engine/angelone-client");
...
router.all("/api/predict-ondemand", async (req, res) => {
  try {
...
router.get("/api/predictResult", async (req, res) => {
  try {
...
function startPredictionServices() {
  start();
...
module.exports = { predictionRouter: router, startPredictionServices };
